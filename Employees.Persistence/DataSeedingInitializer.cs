...
namespace Paycompute.Persistence
{
    public static class DataSeedingInitializer
    {
                                                 ...
                                                 RoleManager<IdentityRole> roleManager)
        {
            ...
            //Create Admin User
            if (userManager.FindByEmailAsync("neilgovender2010@gmail.com").Result == null)
            {
                IdentityUser user = new IdentityUser
                {
                    UserName = "neilgovender2010@gmail.com",
                    Email = "neilgovender2010@gmail.com"
                };
                IdentityResult identityResult = userManager.CreateAsync(user, "Joshua187").Result;
            ...
            if (userManager.FindByEmailAsync("manager@gmail.com").Result == null)
            {
                ...
                IdentityResult identityResult = userManager.CreateAsync(user, "pass.123").Result;
                if (identityResult.Succeeded)
                {
